...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-update/security/advisories/new).
...
- **Email** — `support@semitexa.com`. Put "security" and the package name
  (`semitexa/update`) in the subject.
...
In scope: anything in `semitexa/update` that lets a request, a job or a message do
