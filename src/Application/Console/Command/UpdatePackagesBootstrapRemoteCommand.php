...
use Semitexa\Update\Application\Service\Packaging\RemoteBootstrap\Support\LocalPrerequisiteChecker;
use Semitexa\Update\Application\Service\Packaging\RemoteBootstrap\Support\RemoteArtifactBuilder;
use Semitexa\Update\Application\Service\Packaging\RemoteBootstrap\Support\RemoteBootstrapLogWriter;
...
use Semitexa\Update\Application\Service\Packaging\RemoteBootstrap\Support\RemoteDeployEnvWriter;
...
use Semitexa\Update\Application\Service\Packaging\RemoteBootstrap\Support\RemotePathInspector;
use Semitexa\Update\Application\Service\Packaging\RemoteBootstrap\Support\RemoteScenarioResolver;
use Semitexa\Update\Application\Service\Packaging\RemoteBootstrap\Support\RemoteSshClient;
...
final class UpdatePackagesBootstrapRemoteCommand extends BaseCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            // Walk up from src/Application/Console/Command/ → package root.
            $scenarioPath = (new RemoteScenarioResolver())->resolve($osInfo, dirname(__DIR__, 4));
